...
const mockDoctors = [
  ...
  { _id: 'doc5', name: 'Dr. Rohit Verma', specialty: 'Neurologist', qualifications: 'MBBS, MD, DM', experience: 14, about: 'Expert in neurology specializing in migraine, epilepsy, and stroke management.', languages: ['Hindi', 'English'], clinicName: 'Rohit Neurology Clinic', clinicAddress: '567 Lajpat Nagar', city: 'Delhi', consultationFee: 900, videoFee: 600, rating: 4.6, reviewsCount: 2800, availableToday: false, gender: 'Male', isVerified: true, image: null },
  ...
  { _id: 'doc7', name: 'Dr. Arjun Nair', specialty: 'Orthopedic', qualifications: 'MBBS, MS', experience: 11, about: 'Orthopedic surgeon specializing in joint replacements and sports injuries.', languages: ['Malayalam', 'Hindi', 'English'], clinicName: 'Arjun Ortho Care', clinicAddress: '321 Koramangala', city: 'Bangalore', consultationFee: 700, videoFee: 400, rating: 4.4, reviewsCount: 1900, availableToday: true, gender: 'Male', isVerified: true, image: null },
  ...
  try {
    ...
    try {
      ...
      if (search) {
        ...
        result = result.filter((d) => d.name.toLowerCase().includes(term) || d.specialty.toLowerCase().includes(term));
      }
      if (sort === 'fee_asc') {
